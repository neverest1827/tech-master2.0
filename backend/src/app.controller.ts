...
export class AppController {
    ...
    getIndexPage(@Res() res: Response): void {
        ...
        const questions = [
            {
                ...
                answer: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum " +
                    "tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. Aenean faucibus nibh et justo cursus id rutrum lorem imperdiet. Nunc ut sem vitae risus tristique posuere."
            },
            {
                title: "Question text goes here",
                answer: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum " +
        ...
        return res.render('index.ejs', {reviews, questions});
    }
}
